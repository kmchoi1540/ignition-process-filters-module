...
ignitionModule {
    ...
    moduleDescription.set("Custom Process data filtering Tools")
...
//    moduleDependencySpecs { }
     ...
     */
    hooks.putAll(mapOf(
        "com.kaychoi.ignition.pid.gateway.GatewayHook" to "G",
        "com.kaychoi.ignition.pid.client.ClientHook" to "C",
        "com.kaychoi.ignition.pid.designer.DesignerHook" to "D"
    ))
